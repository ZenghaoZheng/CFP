...
def parse_args():
    ...
    parser.add_argument('--use_2dgt', action='store_true')
    parser.add_argument('--model', default='', type=str)
    parser.add_argument('--channel', default=512, type=int)
    parser.add_argument('--dct_ratio', default=0.7, type=float)
    ...
    parser.add_argument('--MAE_reload', type=int, default=0)
    parser.add_argument('--refine_reload', type=int, default=0)
    parser.add_argument('--reload', type=int, default=0)
    parser.add_argument('--refine', action='store_true')
    parser.add_argument('--in_channels', default=2)
    parser.add_argument('--test_in_train', type=int, default=1)
